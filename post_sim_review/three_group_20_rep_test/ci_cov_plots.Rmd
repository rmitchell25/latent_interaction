...
for (i in 1:nrow(combinations)) {
  ...
  p <- ggplot(plot_data, aes(x = sample_size, y = ci.cov,
                             color = model_type,
                             group = model_type)) +
    ...
    labs(
      title = paste0("Confidence Interval Coverage | RSQ_prod = ", combinations$rsq_prod[i],
                     ", items = ", combinations$n_items[i]),
      x = "Sample Size", y = "CI Coverage") +
    theme_bw() +
    theme(
